    ...
    <div class="fillcontain">
        ...
        <div class="search-box" id="searchBox">
            ...
            <el-form :model="search" ref="ruleForm" >
                <el-form-item :label="$t('message.CostDateStr')" prop="number" :label-width="nameW">
                    <el-date-picker
                ...
                <el-form-item :label="$t('message.OrderNo')" prop="orderno" :label-width="companyW">
                    <el-input clearable v-model="search.OrderNo"></el-input>
                </el-form-item>
            </el-form>
            <div class="button-line">
                <el-tooltip class="item" effect="dark" :content="$t('message.export')" placement="top">
                    <el-button type="primary" @click="downloadData" icon="iconfont icon-xiazai-kong"></el-button>
                </el-tooltip>
        ...
        <div class="table_container" v-loading='isloading' style="padding-top: 20px">
            <el-table
                ...
                <el-table-column :label="$t('message.OrderNo')" prop="OrderNo"></el-table-column>
                <el-table-column :label="$t('message.AmexOrderNo')" prop="AmexOrderNo"></el-table-column>
                <el-table-column :label="$t('message.Passenger')" prop="Passenger"></el-table-column>
                <el-table-column :label="$t('message.Routing')" prop="Routing"></el-table-column>
                <el-table-column :label="$t('message.TicketNo')" prop="TicketNo"></el-table-column>
                <el-table-column :label="$t('message.CostDateStr')" prop="CostDateStr"></el-table-column>
                <el-table-column :label="$t('message.InvoiceDate')" prop="InvoiceDate"></el-table-column>
                <el-table-column :label="$t('message.GrossAmount')" prop="GrossAmount"></el-table-column>
                <el-table-column :label="$t('message.SendDate')" prop="Flag"></el-table-column>
                <!-- <el-table-column :label="$t('message.ta_ApplicationNumber')" prop="OrderNo"></el-table-column>
                <el-table-column :label="$t('message.bi_billNumber')" prop="Flag"></el-table-column>
                <el-table-column :label="$t('message.bi_billPassenger')" prop="Passenger"></el-table-column>
                <el-table-column :label="$t('message.bi_billRouting')" prop="Routing"></el-table-column>
                <el-table-column :label="$t('message.bi_billCostDate')" prop="CostDate"></el-table-column>
                <el-table-column :label="$t('message.bi_billAmexOrderNo')" prop="AmexOrderNo"></el-table-column> -->
                <!--<el-table-column :label="$t('message.bi_billLoginID')" prop="LoginID"></el-table-column>-->
                <!-- <el-table-column :label="$t('message.bi_date')" prop="InvoiceDate"></el-table-column>
                <el-table-column :label="$t('message.bi_SumAmount')">
                    <template slot-scope="scope">
                        {{scope.row.GrossAmount  | NumFormat}}
                    </template>
                </el-table-column> -->
            </el-table>
    ...
    export default {
        ...
        methods: {
            downloadData(){
                ...
                let BaseUrl = baseUrl;
                let downloadUrl = BaseUrl + "/api/AirPlusInterface/DownLoadAirPlusTransactionData?timeFrom="+this.date[0]+"&timeTo="+this.date[1];
                ...
                this.$refs[params].validate((valid) => {
                    if (valid) {
                        this.$router.push({
                            ...
                            query: {
                                company: this.addCost.company,
                                team: this.addCost.team,
                                ExpenseTypeID: this.addCost.ExpenseTypeID,
                            }
                        });
                    } else {
                        return false;
            ...
            getApplyList() {
                ...
                GetAirPlusTransaction(params).then(response => {
                    this.tableData = response.data.Result.lstBill;
