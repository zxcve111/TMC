<template>
    <div class="fillcontain">
        ...
        <div class="table_container"  v-loading='isloading'>
            ...
            <el-dialog :title="dialotitle" :modal-append-to-body="false" :visible.sync="dialogAddVisible2"  width="900px" :close-on-click-modal='false' @close="CancelNewRole">
                <el-form :model="addForm" :rules="rules" ref="addForm" :label-width="labelWidth" class="clear">
                    <el-form-item :label="$t('message.pr_country')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_cnSurname')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_cnname')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_enSurname')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_enname')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_Gender')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_birth')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_phone')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_telephone')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.pr_mailbox')"  prop="RoleName" style="float: left;width: 33%;">
                        <el-input v-model="addForm.RoleName" auto-complete="off"></el-input>
                    </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
