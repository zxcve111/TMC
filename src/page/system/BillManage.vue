    ...
    <div class="fillcontain">
        ...
        <div class="search-box" id="searchBox">
            ...
            <el-form :model="search" ref="ruleForm">
                ...
                <el-form-item :label="$t('message.bi_date')" prop="billdate" :label-width="labelWidth">
                    <el-input clearable v-model="search.Billdate"></el-input>
                </el-form-item>
            </el-form>
        ...
        <div class="table_container" v-loading='isloading' style="padding-top: 20px">
            <el-table
                ...
                <el-table-column :label="$t('message.InvoiceDate')" prop="InvoiceDateStr"></el-table-column>
                <el-table-column :label="$t('message.GrossAmount')" prop="GrossAmount"></el-table-column>
                <el-table-column :label="$t('message.bi_date')" prop="Flag"></el-table-column>
                <!-- <el-table-column :label="$t('message.bi_SumAmount')">
                    <template slot-scope="scope">
                        {{scope.row.SumAmount | NumFormat}}
                    </template>
                </el-table-column> -->
                <!-- <el-table-column :label="$t('message.bi_date')" prop="DBIDate"></el-table-column> -->
    ...
    export default {
        ...
        methods: {
            downloadData(){
                ...
                let BaseUrl = baseUrl;
                let downloadUrl = BaseUrl + "/api/AirPlusInterface/DownLoadAirPlusBillData?timeFrom="+this.date[0]+"&timeTo="+this.date[1];
                window.open(downloadUrl);
                // axios.get(downloadUrl,{params:{
                //     }
            ...
            getApplyList() {
                ...
                let params = {
                    ...
                    flag:this.search.Billdate
                }
                GetAirPlusBill(params).then(response => {
